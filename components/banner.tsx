...
export const Banner = () => {
  return (
    <section className="relative flex h-dvh min-h-dvh items-center justify-center">
      <div className="container grid gap-8 md:grid-cols-2 md:gap-0">
        <div className="justify-center-safe items-center-safe flex">
          <Image src="/logo.webp" width={395} height={640} alt="Banner" className="h-auto w-2/3" priority />
        </div>
        <div className="justify-center-safe flex flex-col items-start space-y-2 px-4 sm:items-center md:items-start">
          ...
          <Separator className="my-3 bg-ulaw-blue/20" />
          <p className="font-teal text-base text-ulaw-blue xl:text-lg 2xl:text-xl">
          ...
          <Separator className="my-3 bg-ulaw-blue/20" />
          <p className="font-bold text-2xl text-ulaw-blue/90 xl:text-3xl 2xl:text-4xl">Lễ kỷ niệm chính thức</p>
          <p className="font-teal text-base text-ulaw-blue/90 xl:text-lg 2xl:text-xl">30/03/2026</p>
        </div>
      </div>
    </section>
  );
